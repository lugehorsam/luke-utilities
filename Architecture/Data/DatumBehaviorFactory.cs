...
namespace Datum
{
    public class DatumBehaviorFactory<TDatum, TBehavior>
        where TBehavior : DatumBehavior<TDatum>, new()
    {
    ...
    public DatumBehaviorFactory(Func<TBehavior> factory)
    {
    ...
    public DatumBehaviorFactory() : this(() => new TBehavior())
    {
